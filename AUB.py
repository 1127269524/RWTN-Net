...
class AUB4(nn.Module):
    ...
    def __init__(self, in_ch=3, mid_ch=12):
        ...
        self.rebnconv1 = PAConv_dil(mid_ch,dilation=1)#进行pconv和两次逐点卷积，第一次逐点有激活函数
        self.rebnconv2 = PAConv_dil(mid_ch,dilation=2)#有激励函数
        self.rebnconv3 = PAConv_dil(mid_ch,dilation=4)#有激励函数
        self.rebnconv4 = PAConv_dil(mid_ch,dilation=8)#有激励函数，都不影响尺寸[4,mid_ch=12,320,320]
...
class AUB6(nn.Module):
    ...
    def __init__(self, in_ch=3, mid_ch=12, out_ch=3):
        ...
        self.rebnconv1 = PAConv_dil(mid_ch,dilation=1)#进行pconv和两次逐点卷积，第一次逐点有激活函数，通道数不变
